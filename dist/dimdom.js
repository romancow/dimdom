/**
 * @license
 * DimDom JavaScript Library v0.2.1-beta.3
...
(function() {
  ...
  DimDom = (function() {
    ...
    DimDom.NSPrefix = {
      xlink: DimDom.NS.XLink,
      xmlns: DimDom.NS.XMLNS
    };
    ...
    createNode = function(document) {
      var attr, childNode, childrenNodes, i, len, name, node, ns, prefix, ref, ref1, ref2, value;
      ...
      for (name in ref) {
        ...
        ref1 = name.split(':', 2), prefix = ref1[0], attr = ref1[1];
        if (attr != null) {
    ...
    ['HTML', 'SVG', 'MathML'].forEach(function(abbr) {
      var ns;
      ns = DimDom.NS[abbr];
      return DimDom[abbr] = (function(superClass) {
        var namespace;
